## Se hicieron pruebas funcionales y de resistencia para validar la resistencia y escuadra de las guias lineales.

### Se detectaron los siguientes problemas a resolver:

#### Problema Detectado: Durante la pruebas funcionales del carro se detecto que al ejercer fuerzas de torsión sobre el carro se produce un aleve separación entre las 2 guías lineales.
- Posible Solución: Se creara un nuevo refuerzo a la mitad de las guias para evitar su separacion (como una via de tren).
